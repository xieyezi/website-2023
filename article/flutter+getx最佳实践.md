---
title: flutter + getx 最佳实践
---

# flutter + getx 最佳实践

![download.png](https://i.loli.net/2021/08/17/Zokmvpb5TFxAaIG.png)
...
首先，你需要将你的`class` 继承自 `GetxView<T>`(T 为你的 Controller)，例如：
...
> 参数的类型可以是一个字符串，一个 Map，一个 List，甚至一个类的实例。
